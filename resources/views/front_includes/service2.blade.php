<div class="container" data-aos="fade-up">
    ...
    <div class="section-title">
        <h2>Astrology Service Provided by Pandit Subhash Mishra</h2>
        <p>Astrology encompasses various systems and traditions that have evolved over centuries across different
            cultures.</p>
    </div>
    ...
    <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-6 d-flex align-items-stretch" data-aos="zoom-in"
            data-aos-delay="100">
            <div class="icon-box iconbox-purple">
                <div class="icon">
