<div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
    <div class="icon-box iconbox-purple">
        <a href="{{URL::to('/matchmaking')}}">
            <div class="icon">
                <img src="{{ asset('front_assets/img/services/matchmaking.jpg') }}" loading="lazy">
            </div>
            <h4>Matchmaking</h4>
            <p>Find your perfect match for life with Pandit Subhash Mishra matchmaking astrological advice.
            </p>
        </a>
        <div class="btn_group">
