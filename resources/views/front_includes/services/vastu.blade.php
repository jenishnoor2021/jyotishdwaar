<div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
    <div class="icon-box iconbox-purple">
        <a href="{{URL::to('/vastu')}}">
            <div class="icon">
                <img src="{{ asset('front_assets/img/services/vastu.jpg') }}" loading="lazy">
            </div>
            <h4>Vastu</h4>
            <p>Enhance your surroundings for success and peace with Pandit Subhash Mishra expert Vastu
                guidance.</p>
        </a>
        <div class="btn_group">
