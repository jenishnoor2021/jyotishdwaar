...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::model($inquiry, [
                'method' => 'PATCH',
                'action' => ['AdminInquiryController@update', $inquiry->id],
                'files' => true,
                'class' => 'form-horizontal',
                'name' => 'editinquiryform',
                ]) !!}
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                placeholder="Enter Name" value="{{ $inquiry->name }}" required>
                            @if ($errors->has('name'))
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" id="email"
                                placeholder="Enter email" value="{{ $inquiry->email }}" required>
                            @if ($errors->has('email'))
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="contact" class="form-control" id="contact"
                                placeholder="Enter contact No" value="{{ $inquiry->contact }}" required>
    ...
    <div class="d-flex gap-2">
        ...
        <a class="btn btn-light w-md" href="{{ URL::to('/admin/inquiry') }}">Back</a>
    </div>
    </form>
</div>
<!-- end card body -->
...
<script>
    $(function() {
        ...
        $("form[name='editinquiryform']").validate({
            rules: {
                name: {
                    required: true,
                },
