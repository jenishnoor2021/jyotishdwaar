...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">ADD Tarot</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open([
                'method' => 'POST',
                'action' => 'AdminTarotController@store',
                'files' => true,
                'class' => 'form-horizontal',
                'name' => 'addtestarotform',
                ]) !!}
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="name">Profile image<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="occupation" id="occupation" placeholder="Enter position" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" name="message" class="form-control" id="message" placeholder="Enter message">{{ old('message') }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="rate" id="rate" placeholder="Enter Rating between 1 to 5" min="1" max="5" required>
                            @if($errors->has('rate'))
...
<script>
    $(function() {
        ...
        $("form[name='addtestarotform']").validate({
            rules: {
                name: {
                    required: true,
                },
